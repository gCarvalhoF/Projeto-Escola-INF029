...
static int matriculaAtual = 120220000;
...
int cadastroProfessor(Pessoa lista_professor[], int qtd_professores)
{
  printf("-----------------------------\n");
  fflush(stdin);
  ...
  lista_professor[qtd_professores].matricula = gerarMatriculaProfessor();
